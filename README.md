...
| **The Darkness** (2007) | Starbreeze engine | 🏆 **Plays in 3D, look stick turns the camera, and the two places VR plugs in are found.** Next: choosing how to draw two eyes. **Tefa’s top VR want** | 09-16 | [the-darkness-vr](https://github.com/TefMeister/the-darkness-vr) |

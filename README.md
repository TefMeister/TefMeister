...
| **RE Village — VR scope** | RE Engine | 🎮 Working, zeroed sniper scope; the flicker hunt is now set up to wear — three test knobs plus one-click helpers, so nothing has to be typed in the headset | 09-17 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |
...
| **Ashes 2063** (2018) | GZDoom | 🔧 Revolver in the right hand, lantern in the left, now sized and turned to the player's drawing; the game's own eye-following brightness is switched off so the lantern really is what lights the dark | 09-17 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

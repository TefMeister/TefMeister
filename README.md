...
| **RE Village — VR scope** | RE Engine | 🔧 The scope should now come up about a second after the rifle is drawn instead of ten; built and installed, a quick check on the monitor comes next | 09-25 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

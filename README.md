...
| **RE Village — VR scope** | RE Engine | 🔧 Lights glitch FIXED (the scope's hidden views now draw after the eyes, self-applying); left: a faint copy of the scope picture leaking into the eyes, cause narrowed to a per-camera cache | 09-25 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

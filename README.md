...
| **RE Village — VR scope** | RE Engine | 🎮 Compared against Resident Evil 4's own working VR scope this week, and the comparison settled an old question: RE4 already draws a real picture inside its scope, Village never did — so building the picture by hand was the only route, not a shortcut. The same look turned up something better: the game appears to hold its own switches for bullet spread and for the wobble that shakes the picture, which are the two things currently being measured and fought. Reading them comes first; none of it needs the game running. | 09-20 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

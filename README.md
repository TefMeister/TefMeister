...
| **Visceral — RE2 VR** | RE Engine | 🎮 `v0.1.0` released; head and controllers reach the game. This week: teaching Claire to keep her normal walk while aiming. The first try used the wrong walk; a corrected version is in for testing. | 09-24 | [visceral-re2-vr](https://github.com/TefMeister/visceral-re2-vr) |

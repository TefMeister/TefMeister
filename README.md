...
| **Ashes 2063** (2018) | GZDoom | 🏆 Two-handed long guns work in the headset. The shotgun now has **gloved hands modelled onto it and running in the game** — right hand on the grip, left on the pump, and during a reload the right hand lets go to feed shells in one at a time. Proved on a flat run; the headset test is next | 09-20 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

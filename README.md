...
| **Visceral — RE2 VR** | RE Engine | 🎮 `v0.1.0` released; head and controllers reach the game. This week: pressing aim no longer changes Claire's body — posture, legs, walk, hand hold, camera jump and tension all fixed and confirmed in play. The last 3 cm slide at the press is now caught inside the engine by a native hook; putting the frame back safely is the one open step. | 09-24 | [visceral-re2-vr](https://github.com/TefMeister/visceral-re2-vr) |
...
| **Ashes 2063** (2018) | GZDoom | 🎮 v0.1.1 out. First rough cube rifle built with both gloved hands, ready to fine-tune together in Blender; the shotgun gets bulkier next | 09-24 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

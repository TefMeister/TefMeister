...
| **RE Village — VR scope** | RE Engine | 🔧 Reinstalled clean; a lights glitch is traced to the scope's mirror itself, and the next test flips its settings one by one | 09-25 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

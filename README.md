...
| **Ashes 2063** (2018) | GZDoom | 🔧 A second, cube-built weapon set is under way: the pistol is worn and working in VR, the lantern has been rebuilt from a reference photo with the hand modelled onto its handle, and the player's own empty left hand now has a relaxed hanging pose and a subtle finger idle. Sleeves are off every hand — black glove only. Still aiming at a first playable release with all eleven weapons modelled, handed, animated and pixelated | 09-22 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

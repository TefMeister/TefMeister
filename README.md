...
| **Visceral — RE2 VR** | RE Engine | 🎮 `v0.1.0` released; head and controllers reach the game. This week: found what hunches Claire when she aims (a per-weapon "look at the target" setting that bends her spine up to 75°); a calmer setting is in the game waiting for a test. | 09-24 | [visceral-re2-vr](https://github.com/TefMeister/visceral-re2-vr) |

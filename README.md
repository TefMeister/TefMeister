...
| **Tomb Raider** (2013) | Foundation | 🔍 Camera readable straight from the game files, including a leftover per-eye slot; a sister game was made VR through its own built-in 3D mode | 09-23 | [tomb-raider-2013-vr](https://github.com/TefMeister/tomb-raider-2013-vr) |
...
| **Borderlands GOTY Enhanced** (2009) | Unreal Engine 3 | 🔍 First look only. A working VR mod for this exact edition already exists (BL1GOTYVR), so what this project is for needs deciding | 09-23 | [borderlands-goty-vr](https://github.com/TefMeister/borderlands-goty-vr) |

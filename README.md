...
| **Ashes 2063** (2018) | GZDoom | 🔧 First 3D weapon now works in the game: the revolver fires and reloads on a flat screen; VR version built, awaiting its first headset test | 09-17 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

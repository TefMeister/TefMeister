...
| **Ashes 2063** (2018) | GZDoom | 🏆 **Two-handed long guns are done and confirmed in the headset.** The handle sits in your right hand, your left hand swings the muzzle, and the shots go where the barrel points — no button, no minimum hand spacing, automatic for every long gun. Next: how the gun SITS in the hand, which is the one thing nobody has judged yet | 09-20 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

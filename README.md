...
| Game | Engine | Where it stands | Updated | Repo |
| --- | --- | --- | --- | --- |
| **RE Village — VR scope** | RE Engine | 🏆 The rifle's own camera now shows on the scope glass by itself. | 09-26 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

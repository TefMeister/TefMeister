...
| **RE Village — VR scope** | RE Engine | 🔧 The scope comes up in under a second, and a measured zero is no longer lost on restart; a quick monitor check, then the headset | 09-25 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

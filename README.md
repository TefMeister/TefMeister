...
| Game | Engine | Where it stands | Updated | Repo |
| --- | --- | --- | --- | --- |
| **RE Village — VR scope** | RE Engine | 🏆 Found why the rifle camera sees nothing: its position maths is never filled in. | 09-26 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

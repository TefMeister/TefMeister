...
| **The Darkness** (2007) | Starbreeze engine | ⭐ **Our own build runs** — plays through the logos and title screen into the opening. Real-time 3D not confirmed yet. **Tefa’s top VR want** | 09-16 | [the-darkness-vr](https://github.com/TefMeister/the-darkness-vr) |

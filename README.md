...
| **Ashes 2063** (2018) | GZDoom | 🔧 A shotgun joins the hand-built weapon set: pump-action, wooden pump, full stock, and much darker and dirtier than the revolver and lantern, which the player found too pale. Its shell shows in the port. Animations next. Holding a rifle with both hands is written and checked and now waits only on the headset PC to build and wear it | 09-18 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

...
| **Ashes 2063** (2018) | GZDoom | 🏆 Two-handed long guns work in the headset — left hand swings the muzzle, shots follow the barrel. The shotgun now has **gloved hands** on it, and during a reload the right hand lets go of the grip and feeds shells in one at a time while the left hand holds the front. Next: a trial of three ways to make the guns look properly pixel-blocky | 09-20 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

...
| **RE Village — VR scope** | RE Engine | 🔧 Lights glitch: the scope's hidden views are drawn before the eyes and take the lights first; a live reorder is built and awaits one headset test | 09-25 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

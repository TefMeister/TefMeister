...
| Game | Engine | Where it stands | Updated | Repo |
| --- | --- | --- | --- | --- |
| **RE Village — VR scope** | RE Engine | 🔧 Polished the rifle camera and made it start by itself when the rifle is drawn. | 09-26 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

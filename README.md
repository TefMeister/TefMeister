...
| **RE Village — VR scope** | RE Engine | 🎮 Working, zeroed sniper scope. All nine of the latest changes were tested in the headset: the weapon-switch flash is fixed, one change that broke the sky and colours was caught and switched off, and the rest went back to the workbench with clear reasons | 09-18 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

...
| **Visceral — RE2 VR** | RE Engine | 🎮 `v0.1.0` released; head and controllers reach the game. This week: teaching Claire to keep her normal walk and stance while aiming, flashlight on or off. Third version is in for testing. | 09-24 | [visceral-re2-vr](https://github.com/TefMeister/visceral-re2-vr) |

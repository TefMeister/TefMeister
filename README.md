...
| **Visceral — RE2 VR** | RE Engine | 🎮 `v0.1.0` released; head and controllers reach the game. New this week: Claire now walks the same way whether she is aiming or not. One flicker in the supporting hand while walking and aiming is being tracked down. | 09-24 | [visceral-re2-vr](https://github.com/TefMeister/visceral-re2-vr) |
...
| **Ashes 2063** (2018) | GZDoom | 🎮 v0.1.1 out. The cube shotgun's gloved hands were shaped cube by cube, its body lengthened; it now fires, pumps (the port opens with the pump) and reloads in the game's own order | 09-24 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

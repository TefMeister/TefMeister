...
| **RE Village — VR scope** | RE Engine | 🔧 Rebuilt from a clean game folder after lights and a dark scope picture were reported; the plain DLSS loader is in, the scope mod (fast start, zero that survives restarts) waits for a headset check | 09-25 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |
...
| **Visceral — RE2 VR** | RE Engine | 🎮 `v0.1.0` released; head and controllers reach the game. This week: pressing aim no longer changes Claire's body — posture, legs, walk, hand hold, camera jump and tension all fixed and confirmed in play. The idle now carries straight through the aim press; the aim press is good enough to play and DLSS works again; a clean install, added back one piece at a time, is next to track down a running shake and a pistol glitch. Leon's aim lists built too, and firing without the aim stance is down to one game-shipped switch to try. | 09-25 | [visceral-re2-vr](https://github.com/TefMeister/visceral-re2-vr) |

...
| **RE Village — VR scope** | RE Engine | 🎮 Two-handed shots now land on the crosshair, confirmed in the headset. Today also turned up that the distance correction was never reaching the scope picture, so close targets hit slightly right; that is fixed and waiting for a re-zero. The scope picture dropped to 1080p for smoother play, with the sharper one kept as an option. | 09-21 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

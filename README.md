...
| **RE Village — VR scope** | RE Engine | 🎮 Working, zeroed sniper scope. The change that broke the sky and colours in the headset has been tracked down and fixed — it was mistaking an ordinary start-up for a problem — and the weapon-switch flash fix is now built into the mod instead of typed in by hand. The rest are back on the workbench with clear reasons | 09-18 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

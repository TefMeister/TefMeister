...
| **RE Village — VR scope** | RE Engine | 🔧 The rifle's inaccuracy is now a measured number: fired from the hip it throws shots up to fifteen degrees off, while aiming brings that to almost nothing — the game scatters each bullet deliberately. The cancel for it moved into compiled code this evening, and the first attempt crashed the game: the safety check I wrote around the change was riskier than the change itself. Rebuilt with that removed, and switching it off is now genuinely harmless. One short test still decides whether it works. | 09-20 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |
...
| **Ashes 2063** (2018) | GZDoom | 🏆 Two-handed long guns work in the headset, and the shotgun now has **gloved hands on it that have been worn** — right hand on the grip, left on the pump, and during a reload the right hand lets go to feed shells in one at a time. Built, put in the game and tested in VR the same evening. Next: a trial of three ways to make the guns look properly pixel-blocky | 09-20 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

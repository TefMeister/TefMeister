...
| **Visceral — RE2 VR** | RE Engine | 🎮 `v0.1.0` released; head and controllers reach the game. This week: pressing aim no longer changes Claire's body — posture, legs, walk, hand hold, camera jump and tension all fixed and confirmed in play. The idle now carries straight through the aim press; a small torso nudge remains in VR, and today's tests point at our own spine-straightening script — one headset check decides. Leon's aim lists built too, and firing without the aim stance is down to one game-shipped switch to try. | 09-24 | [visceral-re2-vr](https://github.com/TefMeister/visceral-re2-vr) |

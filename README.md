...
| **Ashes 2063** (2018) | GZDoom | 🎮 The cube-built weapon line is now in the game: the pistol, a lantern rebuilt from a reference photo with the carrying hand modelled onto its handle, and the player's own empty left hand for one-handed weapons, hanging relaxed with a subtle finger idle. Loads clean; waiting on its first wear. Sleeves are off every hand — black glove only. Still aiming at a first playable release with all eleven weapons modelled, handed, animated and pixelated | 09-22 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

...
| **The Darkness** (2007) | Starbreeze engine | 🏆 **First true left-eye / right-eye picture, and the first stereo bug already fixed** — the eye nudge now happens in the camera, so lighting agrees with geometry. Next, and now blocking everything: hold the world still for the instant between the two eyes | 09-18 | [the-darkness-vr](https://github.com/TefMeister/the-darkness-vr) |

...
| **Ashes 2063** (2018) | GZDoom | 🎮 Cube-built weapons in the game and being tuned from real VR wears: the pistol, and a lantern rebuilt from a reference photo with a full-size gloved hand on its handle, blue flicker and lightning inside the glass. The player's own free left hand is next, and is being modelled hands-on in Blender rather than tuned at a distance. Still aiming at a first playable release with all eleven weapons modelled, handed, animated and pixelated | 09-23 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

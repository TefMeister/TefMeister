...
| **Far Cry 2** (2008) | Dunia | ⏸ Paused: another Far Cry 2 VR mod is working in a headset (not yet released); our v0.2.0-alpha stays up, and we watch theirs | 09-23 | [far-cry-2-vr](https://github.com/TefMeister/far-cry-2-vr) |
| **RE Village — VR scope** | RE Engine | 🔧 Tested on the monitor: the scope now starts by itself the moment the rifle comes out, aimed at the eye from the start, and a stray button can no longer flip it. Next is a look in the headset | 09-24 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |
...
| **Visceral — RE2 VR** | RE Engine | 🎮 `v0.1.0` released; head and controllers reach the game. This week: pressing aim no longer changes Claire's body — posture, legs, walk, hand hold, camera jump and tension all fixed and confirmed in play. The idle now carries straight through the aim press; the aim press is now good enough to play (profiles fixed, firing works); next is a 'fire only' trigger so aiming never moves the body, and steadying REFramework's running camera shake. Leon's aim lists built too, and firing without the aim stance is down to one game-shipped switch to try. | 09-25 | [visceral-re2-vr](https://github.com/TefMeister/visceral-re2-vr) |
| **Dead Space 2** (2011) | RenderWare-based | ⏸ Paused: chortdev's Dead Space trilogy VR mod is on the way (Dead Space 2 planned for about mid-2027); we watch it | 09-23 | [dead-space-2-vr](https://github.com/TefMeister/dead-space-2-vr) |
...
| **Mad Max** (2015) | Apex Engine | 🔧 The world moves under our control, but the HUD moves with it; a VR mod on a sibling Avalanche game now gives a map to follow | 09-23 | [mad-max-vr](https://github.com/TefMeister/mad-max-vr) |
...
| **Portal** (2007) | Source | ⏸ Paused: a playable Portal VR mod already exists (BowmanFox's portal1vr); we watch it | 09-23 | [portal-vr](https://github.com/TefMeister/portal-vr) |
| **Tomb Raider** (2013) | Foundation | ⏸ Paused: farmerarmor's TombRaiderVR already exists; we watch it and may build on it | 09-23 | [tomb-raider-2013-vr](https://github.com/TefMeister/tomb-raider-2013-vr) |
...
| **Death Stranding Director's Cut** (2022) | Decima | ⏸ Paused: Luke Ross's R.E.A.L. VR already plays it; we watch it | 09-23 | [death-stranding-vr](https://github.com/TefMeister/death-stranding-vr) |
...
| **Condemned 2: Bloodshot** (2008) | Xbox 360 static recompilation (ReXGlue) | ⭐ Running on PC from a self-built recompile and on the fast test PC at well over 190 frames a second. Three VR mods on the same engine family found for the two-eyes work | 09-23 | [condemned-2-vr](https://github.com/TefMeister/condemned-2-vr) |
...
| **Borderlands GOTY Enhanced** (2009) | Unreal Engine 3 | ⏸ Paused: a working VR mod already exists (Mastersellz's BL1GOTYVR); we watch it and may build on it | 09-23 | [borderlands-goty-vr](https://github.com/TefMeister/borderlands-goty-vr) |
...
| **Bulletstorm: Full Clip Edition** (2011) | Unreal Engine 3 | 🔍 Installed on the dev PC (11 GB); no static look yet, but a VR mod on a same-tech game now maps the likely hook points | 09-23 | [bulletstorm-vr](https://github.com/TefMeister/bulletstorm-vr) |
...
| **Ashes 2063** (2018) | GZDoom | 🎮 v0.1.1 out. First rough cube rifle, jackhammer and flamethrower built with both gloved hands, ready to fine-tune together in Blender | 09-24 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

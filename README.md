...
| Game | Engine | Where it stands | Updated | Repo |
| --- | --- | --- | --- | --- |
| **RE Village — VR scope** | RE Engine | 🔍 The rifle camera's slowdown was our own script; fixed, now 150+ fps, and the barrel is hidden. | 09-26 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

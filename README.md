...
| **RE Village — VR scope** | RE Engine | 🔧 The scope can now start by itself the moment the rifle comes out, the picture is aimed at the eye from the start, and a stray button can no longer flip it upside down. All built, waiting for a test run | 09-24 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |
...
| **Ashes 2063** (2018) | GZDoom | 🎮 v0.1.1 out. The animated cube shotgun was worn in VR and looks good; next it gets bulkier and more weathered, shaped together in Blender | 09-24 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

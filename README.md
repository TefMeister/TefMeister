...
| **Visceral — RE2 VR** | RE Engine | 🎮 `v0.1.0` released; head and controllers reach the game. This week: pressing aim no longer changes Claire's body — posture, legs, walk, hand hold, camera jump and tension all fixed and confirmed in play. The last 3 cm slide at the press: the engine's own "start at this frame" slot was found on paper and the hook now uses it — one launch decides. Leon's aim lists built too. | 09-24 | [visceral-re2-vr](https://github.com/TefMeister/visceral-re2-vr) |

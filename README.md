...
| **Visceral — RE2 VR** | RE Engine | 🎮 `v0.1.0` released; head and controllers reach the game. This week: Claire now uses her normal walk while aiming, but the hunched aiming stance turned out to be added by the game on top, so that is the next hunt. | 09-24 | [visceral-re2-vr](https://github.com/TefMeister/visceral-re2-vr) |

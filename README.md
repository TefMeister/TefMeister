...
| **Ashes 2063** (2018) | GZDoom | 🎮 **Two-handed long guns work in the headset** — the handle sits in your right hand and the left hand swings the muzzle, and you can see it move. Worn and confirmed 2026-09-20. The bullets have just been pointed down the same line, so they leave the barrel you can see; that half is built and waiting on the next wear | 09-20 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

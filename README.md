...
| **RE Village — VR scope** | RE Engine | 🔧 Zeroed in the headset and the zero now holds over a restart; the scope comes up in under a second. Next: keeping it alive through save loads, and a zoom per scope | 09-25 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

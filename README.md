...
| **Visceral — RE2 VR** | RE Engine | 🎮 `v0.1.0` released; head and controllers reach the game. This week: the hunched aiming stance is fixed and confirmed in play (it was a per-weapon "look at the target" setting bending her spine); now making her legs and torso walk normally while aiming. | 09-24 | [visceral-re2-vr](https://github.com/TefMeister/visceral-re2-vr) |

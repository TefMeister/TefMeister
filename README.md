...
| **Ashes 2063** (2018) | GZDoom | 🎮 v0.1.1 out and confirmed on a fresh install: revolver, gloved-hand pistol, two-handed shotgun and lantern in VR, needing only the plain Ashes 1.51 pack. Now tuning one weapon at a time | 09-23 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

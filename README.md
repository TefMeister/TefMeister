...
| **Ashes 2063** (2018) | GZDoom | 🎮 The hand-built shotgun is now in the game: it replaces the flat picture, fires, throws the shell out and reloads shell by shell. The engine change for holding a long gun with both hands is built and installed too, with its two tuning limits on sliders, so it can be adjusted while wearing the headset. Both are waiting on one headset session to be judged | 09-19 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

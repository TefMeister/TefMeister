...
| **RE Village — VR scope** | RE Engine | 🎮 Working, zeroed sniper scope; the picture now returns by itself after a weapon switch | 09-14 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |
...
| **The Darkness** (2007) | Starbreeze engine | ⭐ Disc copied and files extracted; two leads found. Waiting on the community PC port — **Tefa’s top VR want** | 09-16 | [the-darkness-vr](https://github.com/TefMeister/the-darkness-vr) |

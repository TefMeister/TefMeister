...
| **RE Village — VR scope** | RE Engine | 🎮 Working, zeroed sniper scope. Three more fixes landed without the game running: the settings file was quietly saving one-off experiments as permanent choices and no longer does, the tuning switches became buttons you can reach inside the headset, and the game's log now survives a restart instead of being wiped. Installed, and riding along with the next start rather than needing one. | 09-18 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

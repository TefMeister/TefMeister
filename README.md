...
| Game | Engine | Where it stands | Updated | Repo |
| --- | --- | --- | --- | --- |
| **RE Village — VR scope** | RE Engine | 🔧 Built the fix for the rifle camera's blank position maths; one flat run to prove it. | 09-26 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

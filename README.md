...
| **Ashes 2063** (2018) | GZDoom | 🏆 Two-handed long guns work in the headset, and the shotgun has **gloved hands on it that have been worn** — right hand on the grip, left on the pump, feeding shells in one at a time during a reload. Now aiming at a first playable release: all eleven weapons modelled, handed, animated and pixelated. Six modelled so far, one with hands | 09-20 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

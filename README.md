...
| **RE Village — VR scope** | RE Engine | 🎮 Two-handed shots now land on the crosshair, confirmed in the headset. The test also showed the gun twitches a little before every shot, one-handed too, and the bullet now ignores that twitch. Next is zeroing the scope again with that fix in, then checking near and far targets hit the same spot. | 09-21 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

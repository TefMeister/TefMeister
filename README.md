...
| **The Darkness** (2007) | Starbreeze engine | 🏆 **Our own build plays in 3D, and the look stick turns the camera** — every flat-screen step before VR is done. Next: the second eye. **Tefa’s top VR want** | 09-16 | [the-darkness-vr](https://github.com/TefMeister/the-darkness-vr) |

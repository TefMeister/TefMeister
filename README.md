...
| **Ashes 2063** (2018) | GZDoom | 🔧 Blender pixel-style 3D weapons timed from the game; the revolver is now packed as a game-ready 3D model, waiting for its first in-game test | 09-17 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

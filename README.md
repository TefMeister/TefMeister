...
| **The Darkness** (2007) | Starbreeze engine | 🏆 **Our own build plays the game in 3D** — the opening car chase renders live, first-person. Next: making the look stick turn the camera, then VR. **Tefa’s top VR want** | 09-16 | [the-darkness-vr](https://github.com/TefMeister/the-darkness-vr) |

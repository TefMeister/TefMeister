...
| **Visceral — RE2 VR** | RE Engine | 🎮 `v0.1.0` released; head and controllers reach the game. This week: pressing aim no longer changes Claire's body — posture, legs, walk, hand hold, camera jump and tension all fixed and confirmed in play. The idle now carries straight through the aim press; the torso push that remained turned out to be a REFramework first-person setting — switched off, the push drops from 16 cm to 3 cm; one headset check before it ships. Leon's aim lists built too, and firing without the aim stance is down to one game-shipped switch to try. | 09-24 | [visceral-re2-vr](https://github.com/TefMeister/visceral-re2-vr) |

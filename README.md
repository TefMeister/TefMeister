...
| **Ashes 2063** (2018) | GZDoom | 🔧 The hand-built shotgun now moves: it fires, works its pump and reloads shell by shell, all timed from the game's own weapon file. Darker and dirtier than the earlier models, as the player asked, with the shell showing in the port on the right. Holding a rifle with both hands is written and checked and waits only on the headset PC to build and wear it | 09-18 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

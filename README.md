...
| **Visceral — RE2 VR** | RE Engine | 🎮 `v0.1.0` released; head and controllers reach the game. This week: pressing aim no longer changes Claire's body — posture, legs, walk, hand hold, camera jump and tension all fixed and confirmed in play. The last 3 cm slide at the aim press is gone on the flat screen — the idle now carries straight through press and release (three launches today); waiting on a headset verdict. Leon's aim lists built too, and firing without the aim stance is down to one game-shipped switch to try. | 09-24 | [visceral-re2-vr](https://github.com/TefMeister/visceral-re2-vr) |

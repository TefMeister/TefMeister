...
| **The Darkness** (2007) | Starbreeze engine | ⭐ **Our own build runs** through the logos and title screen. The 3D engine is not confirmed yet — what looked like it was the trailer. **Tefa’s top VR want** | 09-16 | [the-darkness-vr](https://github.com/TefMeister/the-darkness-vr) |

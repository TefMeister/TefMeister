...
- **[lanes-plugin](https://github.com/TefMeister/lanes-plugin)** — the Claude Code plugin every project here is worked with: several sessions at once without them treading on each other, a shared work board, one naming rule (nobody's name is written down unless they choose one), and ideas that get filed by themselves. Public since 2026-09-24, early version, still being built.

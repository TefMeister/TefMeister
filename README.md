...
| **Ashes 2063** (2018) | GZDoom | 🎮 Long guns are now held with two hands all the time: pick one up and the shot follows the line between your hands, with nothing to press and no conditions at all. The shotgun's low aim and the stuck lantern from the first headset try are both fixed. All of it is waiting on one wear | 09-20 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

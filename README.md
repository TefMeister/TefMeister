...
| **Ashes 2063** (2018) | GZDoom | 🔧 Blender pixel-style 3D weapons, now all timed frame-for-frame from the game itself, with every weapon's fire rate worked out; not in the game yet | 09-17 | [ashes-2063-weapons](https://github.com/TefMeister/ashes-2063-weapons) |

...
| **RE Village — VR scope** | RE Engine | 🔧 The scope now comes up in under a second when the rifle is drawn, down from ten (checked on the monitor). Next is a look in the headset | 09-25 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

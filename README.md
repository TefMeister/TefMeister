...
| **RE Village — VR scope** | RE Engine | 🔧 The lights glitch is cornered: the world gets lit as if seen from the scope, so the next job is how the game picks its lights for each view | 09-25 | [re-village-scope-vr](https://github.com/TefMeister/re-village-scope-vr) |

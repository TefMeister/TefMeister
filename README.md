...
| **The Darkness** (2007) | Starbreeze engine | 🏆 **The trick that gives each eye its own view now works in the running game** — proved live, not just on paper. A hidden developer menu and free camera also turned out to be in the retail game, one small change away. Next: both eyes at once | 09-18 | [the-darkness-vr](https://github.com/TefMeister/the-darkness-vr) |
